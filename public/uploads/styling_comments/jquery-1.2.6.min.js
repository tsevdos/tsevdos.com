  ...
  jQuery.fn = jQuery.prototype = {
    ...
    find: function (selector) {
      ...
      return this.pushStack(
        /[^+>] [^+>]/.test(selector) || selector.indexOf("..") > -1 ? jQuery.unique(elems) : elems,
      );
    },
    ...
    val: function (value) {
      ...
      return this.each(function () {
        ...
        if (value.constructor == Array && /radio|checkbox/.test(this.type))
          this.checked =
            jQuery.inArray(this.value, value) >= 0 || jQuery.inArray(this.name, value) >= 0;
        else if (jQuery.nodeName(this, "select")) {
          var values = jQuery.makeArray(value);
          jQuery("option", this).each(function () {
            this.selected =
              jQuery.inArray(this.value, values) >= 0 || jQuery.inArray(this.text, values) >= 0;
          });
    ...
    if (elem)
      with (jQuery.browser) {
        ...
        if (elem.getBoundingClientRect) {
          ...
          if (
            (safari2 && (fixed || css(offsetChild, "position") == "absolute")) ||
