    ...
    <div className="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="space-y-6">
          ...
          <p className="text leading-relaxed text-gray-300">
            Αυτό το site χρησιμοποιεί διάφορα{" "}
            <a
            ...
            εργαλεία και τεχνολογίες, όπως το{" "}
            <a
            ...
            για static site generation (SSG),{" "}
            <a
            ...
            για edge hosting και functions, και τέλος{" "}
            <a
      ...
      <div className="flex flex-col md:flex-row-reverse md:justify-between space-y-6 md:space-y-0 text-center md:text-left text-sm">
        ...
        <div className="text-gray-400">
          <span className="font-medium">&copy; Tsevdos.com - Made with ❤️ in Athens, Greece</span>
        </div>
      </div>
    </div>
  </footer>
