...
const PostPreview: FC<PostData> = ({ slug, title, date }) => (
  <div className="my-2 lg:my-3">
    <Link
      href={`/${slug}`}
      className="transition group flex flex-row items-center p-4 border-b overflow-hidden border-gray-300 cursor-pointer hover:bg-indigo-100"
    >
