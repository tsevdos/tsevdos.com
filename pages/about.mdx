...
export const meta = {
  title: "About",
  description: "Το προσωπικό blog του Γιάννη Τσεβδού.",
};
...
Για περισσότερες πληροφορίες ρίξτε μια ματιά στο [βιογραφικό μου](http://www.tsevdos.com/wp-content/uploads/john_tsevdos_cv.pdf "John Tsevdos CV").
